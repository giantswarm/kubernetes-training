...
kubectl apply --filename ./cluster/addons/fluentd-elasticsearch/
...
kubectl apply --filename ./contrib/kube-prometheus/manifests/
...
# giantswarm/twitter-hot-urls-example
kubectl apply --filename ./manifests/monitoring
